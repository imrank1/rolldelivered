...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=464773370242211";
              ...
              <div class="side_box">
               ...
               <div class="side_box">
                       ...
                       <div class="content_middle" align="center">
                           ...
                           <a href="#myModal" role="button" class="" data-toggle="modal">Want to cancel?</a>
                       <div class="clear"></div>
                            </div>
                 <div class="bottom"></div>
              </div>
  ...
  <div class="main_box_background"> <!-- start box background -->
    ...
    <div class="modal hide fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        ...
        <h3 id="myModalLabel">Cancell My Account: We're sad to see you go!</h3>
      </div>
