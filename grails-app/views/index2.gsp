...
<div id="bg_top">
    ...
    <!--        <div class="left_460">
            ...
            <div class="two_column_wrapper">
                ...
                <p><img src="images/formheader.png" /></p>
				<p>Enter your details to order and Simplify Your Life.</p>
                <div class="span6 columns">
    <fieldset>
      <form accept-charset="UTF-8" action="/users" class="form-stacked" id="new_user" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ULpEFUo0IuwHH7VyJXltb0ZkfrV8AJwrERUz3zJSJUk=" /></div>

        <div class="clearfix">
          <label for="user_name">Name</label>
          <div class="input">
            <input class="field" id="user_name" name="user[name]" size="30" type="text" />
          </div>
        </div>
        ...
        <div id="credit-card" style="display:block">
          ...
          <div class="clearfix">
            ...
            <div class="input">
              <input class="field" id="credit_card_number" name="credit_card_number" type="text" />
            </div>
          </div>
          ...
          <div class="clearfix">
            ...
            <div class="input">
              <input class="input-small"  id="cvv" name="cvv" type="text" />
            </div>
          </div>
          ...
          <div class="clearfix">
            ...
            <div class="input">
              <input id="_expiry_date_3i" name="[expiry_date(3i)]" type="hidden" value="1" />
<select class="input-small" disabled="disabled" id="_expiry_date_2i" name="[expiry_date(2i)]">
...
<select class="input-small" id="_expiry_date_1i" name="[expiry_date(1i)]">
